...
class ItemControllerTest {
    ...
    @Test
    @SneakyThrows
    void getExceptionWithCreateWithoutHeader() {
    ...
    @Test
    @SneakyThrows
    void getExceptionWithGetAllByUserIdWithFromMoreThenMaxInt() {
    ...
    @Test
    @SneakyThrows
    void getExceptionWithGetByItemIdWithoutHeader() {
    ...
    @Test
    @SneakyThrows
    void getExceptionWithSearchWithoutHeader() {
    ...
    @Test
    @SneakyThrows
    void getExceptionWithSearchWithoutText() {
    ...
    @Test
    @SneakyThrows
    void getExceptionWithSearchWithFromMoreThenMaxInt() {
    ...
    @Test
    @SneakyThrows
    void getExceptionWithCommentWithoutHeader() {
